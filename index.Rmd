...
#database_title <- paste("201202COVID19MEXICO.csv")
...
plot_Casos_Mx <- plot_ly(mn_Mx_2,
  ...
  layout(title = ~paste("<b>Casos positivos acumulados en México (n = </b>",n_Mx,"<b>)</b>"),
         ...
         annotations = list(text = ~paste("<b>Hospitalizados:</b>", n_hosp,
                            ...
                            x = "2020-03-25", y = 8150, showarrow=F,
                            font=list(color = "darkgreen")),
         bargap = 0);plot_Casos_Mx
...
plot_def_Tlx <- plot_ly(Defunciones_Tlx_2,
  ...
  layout(title = ~paste("<b>Fallecimientos en Tlaxcala (n = </b>",n_def_Tlx,"<b>)</b>"),
         ...
         annotations = list(text = ~paste("<b>Hospitalizados:</b>", n_hosp,
                                          "<br><b>Ambulatorios:</b>", n_amb),
                            x = "2020-05-20", y = 30, showarrow=F,
                            font=list(color = "darkgreen")),
         bargap = 0); plot_def_Tlx
...
nov_tlax$mes <- rep("Noviembre", length(nov_tlax$fecha_actualizacion))
...
dic_tlax$mes <- rep("Diciembre", length(dic_tlax$fecha_actualizacion))

def_mes_Tlx <- bind_rows(marzo_tlax, abril_tlax, mayo_tlax, jun_tlax, jul_tlax, agos_tlax, sept_tlax, oct_tlax, nov_tlax, dic_tlax)
def_mes_Tlx$mes <- factor(def_mes_Tlx$mes,  levels = c("Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre"))
