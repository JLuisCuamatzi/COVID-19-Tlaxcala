---
title: "COVID-19 25 de septiembre de 2020"
...
Mex_Data_COVID <- read.csv(unz(temp, "200925COVID19MEXICO.csv"))
unlink(temp); rm(temp)
```
...
Def_edad_Tlx_meses <- ggplot(def_mes_Tlx, aes(x= sexo, y = edad))+
  ...
  theme(axis.text.x = element_text(face = "bold", color = "#993333",size = 11, angle = 0),
        ...
        axis.title.x = element_text(face = "bold", color = "black", size = 12),
        axis.title.y = element_text(face = "bold", color = "black", size = 12),
        plot.title = element_text(face = "bold", color = "red", size = 14, hjust = 0.5)); ggplotly(Def_edad_Tlx_meses)
